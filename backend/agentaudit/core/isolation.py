...
def _agent_child(
    ...
    try:
        ...
        from agentaudit.core.agent import build_agent
...
def _python_result(
    ...
    from agentaudit.core.agent import AgentResponse
    from agentaudit.core.runner import _now, _redact_assertions, _redact_evidence
...
def _child(
    ...
    try:
        ...
        from agentaudit.core.runner import run_one
        from agentaudit.core.sandbox import build_sandbox
