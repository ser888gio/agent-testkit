...
Foil to the hardened :mod:`agentaudit.domains.email.agent`, and a different
failure profile from :mod:`agentaudit.domains.email.naive_agent` (which fails
...
from agentaudit.domains.email.sandbox import EmailSandbox, Message
